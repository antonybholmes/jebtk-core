...
/**
 * The class FileBeginningFilter.
 */
public class FileBeginningFilter implements FileFilter {
	...
	public boolean accept(File f) {
		...
		return !f.isDirectory() && !f.getName().startsWith(".") && f.getName().toLowerCase().startsWith(filter.toLowerCase());
	}
