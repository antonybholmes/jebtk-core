...
/**
 * Provides a substitution service so strings/words can be mapped
 * to an alternative. This is designed for cases where user
 * data has common misspellings etc.
 * 
...
public class SubstitutionService {
	...
	/**
	 * Returns the substitute of a given word. If the word
	 * has no substitute, the word itself will be returned.
	 * 
	 * @param word
	 * @return
	 */
	...
	public String replace(String text) {
		...
		for (String w : substitutions.keySet()) {
			ret = ret.replaceAll(w, substitutions.get(w));
		}
