...
/**
 * Trimmer removes characters such as spaces from the beginning or end of
 * a string. This is used in conjuction with {@code Splitter} to create
 * a functional way to split strings.
 */
