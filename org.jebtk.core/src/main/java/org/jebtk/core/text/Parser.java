...
public class Parser {
	...
	public static final Pattern ENDS_WITH_NUMBER_PATTERN = 
			Pattern.compile("([-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?)$");
	...
	/**
	 * Extracts the numerical portion of a string and returns it as a double
	 * or Double.NaN if no number if found.
	 *
	 * @param field the field
	 * @return the double
	 */
