...
/**
 * Provides a fixed size circular buffer that removes
 * the oldest element once the buffer is filled. The implementation
 * means there is no array resizing or copying.
 *
