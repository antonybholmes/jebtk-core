...
/**
 * Can be used to create a sub view of a list without creating a new
 * list instance each time. Since this is a view, the internal list
 * cannot be edited and calls to subList() and toObject() will be slower
 * since it is assumed that these will not be called on a view, despite
 * being valid.
 *
