...
public class TOTP {
	...
	/**
	 * Check that two totp phrases generated on different machines are
	 * the same.
	 *
	 * @param phrase the phrase
	 * @param totp the totp
	 ...
	 * @return the string
	 */
	public static String totp256(String key,
			long time,
			long epoch, 
			long step) {
	 ...
	 * @return the string
	 */
	public static int generateTOTP(String key,
			long time,
			long epoch, 
			long step) {
	...
	/**
	 * Generates a standard 8 digit TOTP code. Returns -1 if there is a
	 * failure.
	 *
	 * @param key the key
	 * @param message the message
	...
	/**
	 * Generates a standard 6 digit TOTP code. Returns -1 if there is a
	 * failure.
	 *
	 * @param key the key
	 * @param message the message
	...
	/**
	 * Converts a hmac hash (must be 32 bytes, 256 bits) to an integer which
	 * can be used to generate totp code. Returns -1 if hash is null.
	 *
	 * @param hash the hash
	 * @return the int
	 */
