...
public class Cryptography {
	...
	/**
	 * Generate a random alpha numeric (case sensitive) string
	 * of n characters.
	 *
	...
	/**
	 * Returns a SHA-512 bit hash of a phrase as hex string after truncation
	 * to 256 bits.
	 *
	 * @param phrase the phrase
	 * @return the SH a256 hash
	...
	/**
	 * Convert byte data to a string using hex notation.
	 * Each byte is represented by 2 characters representing
	 * a hex number between 0-256.
	 *
	 * @param buf the buf
	 * @return the string
	 */
