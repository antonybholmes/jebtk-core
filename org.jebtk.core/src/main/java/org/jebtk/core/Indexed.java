...
public class Indexed<K extends Number, V extends Comparable<? super V>> implements Comparable<Indexed<K, V>> {
	 ...
	 */
	public static <K1 extends Number, V1 extends Comparable<? super V1>> List<K1> indices(Collection<Indexed<K1, V1>> items) {
	 ...
	 * @return the map
	 */
	public static <T extends Number, V extends Comparable<? super V>> Map<V, T> mapValuesToIndex(List<Indexed<T, V>> values) {
	...
	public static <K1 extends Number, V1 extends Comparable<? super V1>> Map<V1, List<Indexed<K1, V1>>> listToMap(
		...
		Map<V1, List<Indexed<K1, V1>>> ret =
				DefaultHashMap.create(new ArrayListCreator<Indexed<K1, V1>>());
	...
	public static <T extends Comparable<? super T>> List<Indexed<Integer, T>> intIndex(Collection<T> items) {
		List<Indexed<Integer, T>> ret = 
				new ArrayList<Indexed<Integer, T>>(items.size());
	...
	public static <T extends Comparable<? super T>> List<Indexed<Integer, T>> intIndex(T[] items) {
		List<Indexed<Integer, T>> ret = 
				new ArrayList<Indexed<Integer, T>>(items.length);
	...
	public static List<Indexed<Integer, Double>> intIndex(double[] items) {
		List<Indexed<Integer, Double>> ret = 
				new ArrayList<Indexed<Integer, Double>>(items.length);
