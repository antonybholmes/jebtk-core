...
public class JsonParser {
	...
	private void parse(char c) {
		...
		case ':':
			if (mStringMode) {
				...
				mCurrentName = mBuffer.toString(); //.subSequence(1, mBuffer.length() - 1); //TextUtils.removeQuotes(String.valueOf(buffer, 0, bc));
	...
	/**
	 * Add the appropriate JSON value to the current
	 * structure.
	 */
