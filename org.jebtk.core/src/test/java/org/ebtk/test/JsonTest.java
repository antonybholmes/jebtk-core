...
public class JsonTest {
	...
	public void testJsonParser() {
		...
		try {
			System.err.println(new JsonParser().parse("[{\"name\":\"edbw\",\"version\":2.0,\"copyright\":\"Copyright (C) 2013-2015 Antony Holmes\"}]"));
	...
	public void testJsonEscapeParser() {
		...
		try {
			Json json = new JsonParser().parse("[{\"test\":\"c:\\\\test\",\"version	\":2.0,\"copy\\\"right\":\"Copyright (C) 2013-2015 Antony Holmes\"}]");
	...
	public void testJsonUnicodeParser() {
		...
		try {
			System.err.println(new JsonParser().parse("[{\"name\":\"\\u0063\",\"version\":2.0,\"copyright\":\"Copyright (C) 2013-2015 Antony Holmes\"}]"));
		} catch (ParseException e1) {
			e1.printStackTrace();
		}
	}
	...
	public void testBuilder() {
		System.err.println("Json test builder " + new JsonBuilder()
				.startArray()
				.add("cake")
				.add(1)
				.add(false)
